...
import { ProductImg, ReactSelectStayle } from "./styles";
...
function Row({ row, setOrders, orders }) {
  ...
  async function setNewStatus(id, status) {
    ...
    try {
      ...
      console.error('Erro ao atualizar o status, tente novamente', error);
    } finally {
      setIsLoading(false)
    }
  }
          ...
          <Collapse in={open} timeout="auto" unmountOnExit>
            <Box sx={{ margin: 1 }}>
              ...
              <Table size="small" aria-label="purchases">
                <TableHead>
                  <TableRow>
                    <TableCell style={{ color: ' #fff' }}> Produto </TableCell>
                    <TableCell style={{ color: ' #fff' }}> Quantidade </TableCell>
                    <TableCell style={{ color: ' #fff' }}> Categoria </TableCell>
                  </TableRow>
                </TableHead>
                <TableBody>
